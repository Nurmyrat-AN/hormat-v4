...
test('registry rejects duplicate keys/groups and missing or invalid module/type/assignability/localization metadata',()=>{
 ...
 assert.deepEqual(permissionDefinitions.flatMap(group=>group.permissions.map(item=>item.key)).sort(),['users.view','users.create','users.update','users.status','users.change_password','permissions.view','permissions.update','media.view','media.upload','media.create_folder','media.rename','media.move','media.delete','vendors.view','vendors.create','vendors.update','vendors.reset_sync','vendors.status','brands.view','brands.create','brands.update','brands.visibility','categories.view','categories.create','categories.update','categories.visibility','discounts.view','discounts.create','discounts.update','discounts.visibility','currencies.frontend.view','currencies.frontend.create','currencies.frontend.update','currencies.frontend.visibility','currencies.vendor_rates.view','currencies.vendor_rates.update','languages.view','languages.create','languages.update','languages.status','languages.default','interface_translations.view','interface_translations.update','payment_types.view','payment_types.create','payment_types.update','payment_types.visibility','delivery_types.view','delivery_types.create','delivery_types.update','delivery_types.visibility','order_statuses.view','order_statuses.create','order_statuses.update','order_statuses.visibility','settings.view','settings.update','products.view','products.create','products.update','products.visibility','source_products.view','superuser'].sort());
